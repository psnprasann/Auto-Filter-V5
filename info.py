...
API_ID = int(environ.get('API_ID', '15432910'))
API_HASH = environ.get('API_HASH', 'bf3b5a92497cf5744e6310f309b5490a')
BOT_TOKEN = environ.get('BOT_TOKEN', "5825721043:AAERqXPhEU8dNBMR0HYPym2ZX5S1UKcbj1Y")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5234476249').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001858491982').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Paramathma:Paramathma@cluster0.qno5wbm.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Paramathma")
...
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', -1001858491982))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001858491982')).split()]
...
# Delete Time
DELETE_TIME = int(environ.get('DELETE_TIME', 30000))
SPL_DELETE_TIME = int(environ.get('SPL_DELETE_TIME', 15))

# URL SHORTNER

URL_SHORTENR_WEBSITE = environ.get('URL_SHORTENR_WEBSITE', 'koklink.in')
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '2892023665092262750f50acac3f77e22abcb5f2')
